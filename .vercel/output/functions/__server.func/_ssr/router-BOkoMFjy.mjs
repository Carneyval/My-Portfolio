...
const appCss = "/assets/styles-D6GqDVRk.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Pramudia Ramadhan" },
...
const $$splitComponentImporter = () => import("./index-KvSd0ddC.mjs");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Pramudia Ramadhan (Rama) — a data scientist turning data into clear, actionable insights through machine learning, NLP, and elegant visualization."
    }, {
      property: "og:title",
      content: "Pramudia Ramadhan — Data Scientist Portfolio"
    }, {
      property: "og:description",
      content: "Data science, machine learning, NLP and visualization work by Pramudia Ramadhan (Rama)."
    }]
  }),
